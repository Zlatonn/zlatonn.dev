    ...
    <div className="relative min-h-screen w-screen bg-secondary">
      <div className="py-28 flex flex-col items-center">
        ...
        <div className="max-w-5xl w-[95%] mt-10 scale-95 sm:scale-100">
          ...
          >
            {/* Card */}
            <Card className="mx-10 w-[300px] bg-gray-300/10 border-[1px] border-light/10 rounded-xl text-light rotate-6 scale-90 hover:rotate-0 hover:scale-100 hover:bg-primary duration-300">
              <CardHeader>
                <img
                  src="https://github.com/Zlatonn/warranty-expiry-checker/raw/master/frontend/src/assets/home%20page.png"
                  className="border-[1px] border-light/10 rounded-md"
                />
              </CardHeader>
              ...
              <CardFooter className="flex gap-2 text-xs text-secondary">
